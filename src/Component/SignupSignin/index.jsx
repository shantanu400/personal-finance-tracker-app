  ...
  return (
    ...
    <div className="signup-wrapper">
      ...
      <form>
        ...
        <Button
          ...
          onClick={Googleauth}
        />
        <p className="p-login" onClick={()=>setLogin(!login)}> or Dont't Have account? Click Here</p>
      </form>
    </div>
    </>
    :
    ...
    <form>
      ...
      <Button
        ...
        onClick={Googleauth}
      />
       <p className="p-signup" onClick={()=>setLogin(!login)}> or Dont't Have account? Click Here</p>
    </form>
  </div>
    }
